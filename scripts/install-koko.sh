...
echo ""
echo "Quick start:"
echo "  koko text \"Hello, world!\"         # Speak text"
echo "  koko text \"Hello\" -o hello.wav    # Save to file"
echo "  koko text \"Hello\" -s af_heart     # Use specific voice"
echo "  koko voices                        # List available voices"
echo ""
echo "Models are downloaded on first run (cached under ~/.cache/kokoros)."
echo ""
